...
def assd(input1, input2, voxelspacing=None, connectivity=1):
    ...
    """
    assd = numpy.mean(
        (asd(input1, input2, voxelspacing, connectivity), asd(input2, input1, voxelspacing, connectivity)))
    return assd
...
def obj_assd(input1, input2, voxelspacing=None, connectivity=1):
    ...
    """
    assd = numpy.mean(
        (obj_asd(input1, input2, voxelspacing, connectivity), obj_asd(input2, input1, voxelspacing, connectivity)))
    return assd
